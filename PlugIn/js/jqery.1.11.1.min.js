...
/*727*/
 $(".channel").hide(); 
   function ofcolor(c,s) {
	
				$("#btn").css("background",c);
				$("#btn").css('background-size',s);
				 $(".channel").toggle(); //显示隐藏切换
            
				$(".tipsbg").on("click", function () {
                $(".channel").hide(); //显示隐藏切换
				$("#btn").css('background','');
				$("#btn").css('background-size','1.1em');
				});
...
function checkdata(myForm)
{
 ...
 var m = $("#namem");var w = $("#namew");var n = $("#name");
  var db = $("#dateb");var dr = $("#dater"); var dt = $("#date"); 
 var tb = $("#timeb");var tr = $("#timer");ti = $("#time")
 var tt = $("#textarea");
 var ds = $("#dsqs");
...
$(this).focus();
    ...
    if (typeof (window.AppObj) != "object") 
   {
    $("#fixd").show(function(){
		$('#p').html('请输入您的姓名');
		});
